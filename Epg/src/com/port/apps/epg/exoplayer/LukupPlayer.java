...
public class LukupPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     *
     * @param player The player for which renderers are being built. {@link LukupPlayer#onRenderers}
     *     should be invoked once the renderers have been built. If building fails,
     *     {@link LukupPlayer#onRenderersError} should be invoked.
     */
    void buildRenderers(LukupPlayer player);
    /**
     * Cancels the current build operation, if there is one. Else does nothing.
     * <p>
     * A canceled build operation must not invoke {@link LukupPlayer#onRenderers} or
     * {@link LukupPlayer#onRenderersError} on the player, which may have been released.
     */
    void cancel();
  }
