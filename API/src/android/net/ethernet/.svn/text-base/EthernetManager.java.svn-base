...
public class EthernetManager {
    ...
    public EthernetManager(IEthernetManager service, Handler handler) {
        if(Constant.DEBUG)  Log.d(TAG, "Init Ethernet Manager, service: " +service);
        mService = service;
        mHandler = handler;
    }
    ...
    public boolean isConfigured() {
        try {
        	...
        	if(Constant.DEBUG)  Log.d(TAG, "Can not check eth config state");
        }
        return false;
    }
    ...
    public EthernetDevInfo getSavedConfig() {
        try {
        	...
        	if(Constant.DEBUG)  Log.d(TAG, "Can not get eth config");
        }
        return null;
    }
    ...
    public void updateDevInfo(EthernetDevInfo info) {
        try {
        	...
        	if(Constant.DEBUG)  Log.d(TAG, "Can not update ethernet device info");
        }
    }
    ...
    public void setEnabled(boolean enable) {
        try {
        	...
        	if(Constant.DEBUG)  Log.d(TAG,"Can not set new state");
        }
    }
