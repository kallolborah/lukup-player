 ...
 * @author janisk
 */
public class MicrotikConnection extends Thread {
   ...
   */
  public MicrotikConnection(String ipAddress, int ipPort) {
  ...
  public boolean login(String name, char[] password) {
      ...
      try {
          ...
          Logger.getLogger(MicrotikConnection.class.getName()).log(Level.SEVERE, null, ex);
          return false;
      }
